...
export const onClientEntry = async () => {
  ...
  window.onload = () => {
    ...
    // script1.dataset.name = "googleanalitycs"
    // script1.dataset.src = "https://www.googletagmanager.com/gtag/js?id=G-5ZPXPLJTPH"
    // script1.async = true
    // document.body.appendChild(script1)
    // const script2 = document.createElement("script")
    // script2.dataset.name = "googleanalitycs"
    // script2.dataset.type="application/javascript"
    // script2.type = "opt-in"
